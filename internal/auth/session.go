...
func LoadEmailFromSession(cfg internal.ConfigService, c echo.Context) (string, error) {
...
func SaveEmailToSession(cfg internal.ConfigService, c echo.Context, email string) error {
	sess, err := session.Get(sessionName, c)
	if err != nil {
